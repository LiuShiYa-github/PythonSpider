...
# -*- coding: utf-8 -*-
"""
@FileName: Outlook2.py
@Time    : 2022/4/14 14:18
@Author  : 热气球
@Software: PyCharm
@Version : 1.0
@Contact : 2573514647@qq.com
@Des     : 通过Outlook获取公司员工的邮箱信息
"""
...
class GetDepartment:
    def __init__(self):
        ...
        self.driver.find_element(By.XPATH, '//*[@id="i0116"]').send_keys('账户')
        time.sleep(1)
        self.driver.find_element(By.XPATH, '//*[@id="idSIButton9"]').click()
        time.sleep(1)
        self.driver.find_element(By.XPATH, '//*[@id="i0118"]').send_keys('密码')
        time.sleep(1)
        self.driver.find_element(By.XPATH, '//*[@id="idSIButton9"]').click()
        time.sleep(1)
        ...
        time.sleep(6)
        self.worksheet = xlrd.open_workbook('开发机用户.xlsx')
    ...
    def get_department(self, staff_name):
        ...
        email = self.driver.find_element(By.XPATH, '/html/body/div[3]/div/div[2]/div[2]/div[1]/div/div[2]/div[2]/div[3]/div/div/div/div/div[2]/section/div/div/div/section/div/div/div/div/div[1]/div/button/div/div/div/span')
        print('姓名：{} 邮件：{}'.format(staff_name, email.text))
